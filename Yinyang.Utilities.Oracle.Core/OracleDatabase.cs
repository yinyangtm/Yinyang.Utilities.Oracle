...
namespace Yinyang.Utilities.Oracle.Core
{
    public class OracleDatabase : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets the string used to open a Oracle database.
        /// </summary>
...
        public string CommandText
        ...
        public OracleDatabase()
        {
            ...
            _sqlCommand = new OracleCommand { Connection = _sqlConnection };
        }
...
        public void AddParameter(string key, object obj)
        {
            _sqlCommand.Parameters.Add(obj == null
                ? new OracleParameter(key, DBNull.Value)
                : new OracleParameter(key, obj));
        }
        ...
        {
            _sqlCommand.Parameters.Add(key, obj);
        }
...
        public void AddParamsToCommand<T>(string paramPrefix, IEnumerable<T> parameters)
        {
            ...
            {
                _sqlCommand.Parameters.Add(parameterNames[i], parameterValues[i]);
            }
        }
